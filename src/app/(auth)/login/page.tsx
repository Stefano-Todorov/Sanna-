    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: 28, paddingBottom: 24, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <p style={{ fontSize: 14, color: '#9ca3af', margin: '4px 0 0' }}>Sign in to your Sana account</p>
        </div>
        ...
        <p style={{ marginTop: 20, textAlign: 'center', fontSize: 14, color: '#6b7280' }}>
          ...
          <Link href="/signup" className="auth-link" style={{ color: '#2dd4bf', textDecoration: 'none' }}>Get started free</Link>
        </p>
      </div>
    </>
  )
